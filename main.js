document.getElementById("header1").innerHTML = "Addlinks";

$(document).ready(function(){
   $("#header1").animate({fontSize: '1.5em'});
...
/*var developerName = document.getElementById("name");
developerName.innerHTML=" &copy; All rights reserved <hr> by Ajx NN.";*/
/*$(document).ready(function(){
    $(".login").hide();
    $(".registration").hide();
      ...
      $("#registrationPanel").mouseover(function(){
